...
fn test_mint_multiple_sequential() {
    ...
    assert!(token_id_1 == 1.into(), "First token should be 1");
    assert!(token_id_2 == 2.into(), "Second token should be 2");
    assert!(token_id_3 == 3.into(), "Third token should be 3");
}
...
fn test_mint_batch_through_component() {
    ...
    assert!(*token_ids.at(0) == 1.into(), "First batch token ID should be 1");
    assert!(*token_ids.at(1) == 2.into(), "Second batch token ID should be 2");
}
...
trait IMockMetagameWithBatch<TContractState> {
    ...
    fn mint_batch(
        ref self: TContractState, mints: Array<crate::metagame::structs::MintMetagameParams>,
    ) -> Array<felt252>;
}
...
mod MockMetagameContractWithBatch {
    ...
    impl MockMetagameWithBatchImpl of super::IMockMetagameWithBatch<ContractState> {
        ...
        fn mint_batch(
            ref self: ContractState, mints: Array<crate::metagame::structs::MintMetagameParams>,
        ) -> Array<felt252> {
