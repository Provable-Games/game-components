...
pub mod RendererComponent {
    ...
    use crate::token_legacy::extensions::renderer::interface::{
        IMINIGAME_TOKEN_RENDERER_ID, IMinigameTokenRenderer,
    };
    use crate::token_legacy::token::address_utils;
    use crate::token_legacy::token_component::CoreTokenComponent;
    use crate::token_legacy::token_component::CoreTokenComponent::EventEmittersTrait;
    use crate::token_legacy::traits::OptionalRenderer;
