...
pub mod CoreTokenComponent {
    ...
    use crate::token_legacy::interface::{
        IMINIGAME_TOKEN_LEGACY_ID, IMinigameRegistryDispatcher, IMinigameRegistryDispatcherTrait,
    ...
    > of IMinigameTokenLegacy<ComponentState<TContractState>> {
        fn token_metadata(
        ...
        fn settings_id(self: @ComponentState<TContractState>, token_id: felt252) -> u32 {
            crate::token_legacy::structs::unpack_settings_id(token_id)
        }
        ...
        fn settings_id_batch(
            ...
            loop {
                ...
                results.append(crate::token_legacy::structs::unpack_settings_id(*token_ids.at(i)));
                i += 1;
            }
            results
        }
    ...
    > of InternalTrait<TContractState> {
        ...
        fn initializer(
            ...
            src5_component.register_interface(IMINIGAME_TOKEN_LEGACY_ID);
