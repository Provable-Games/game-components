...
use crate::token_legacy::interface::{IMINIGAME_TOKEN_LEGACY_ID, IMinigameTokenMixinDispatcherTrait};
use crate::token_legacy::structs::{MintBatchRecipient, PlayerNameUpdate};
...
fn test_initializer_src5_interface_registered() {
    ...
    assert!(supports, "Should support IMINIGAME_TOKEN_LEGACY_ID interface");
}
