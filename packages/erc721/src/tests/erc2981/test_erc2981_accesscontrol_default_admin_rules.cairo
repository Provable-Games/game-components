...
use crate::common::erc2981::{DefaultConfig as ERC2981DefaultConfig, ERC2981Component};
use crate::tests::support::test_common::mocks::erc2981::ERC2981AccessControlDefaultAdminRulesMock;
use crate::tests::support::testing::constants::{
    ADMIN, OTHER, OTHER_ADMIN, OTHER_ROLE, RECIPIENT, ZERO,
};

type MockState = ERC2981AccessControlDefaultAdminRulesMock::ContractState;
