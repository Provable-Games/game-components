...
use crate::features::minter::{MinterComponent, IMinterComponent};
use crate::features::multi_game::{MultiGameComponent, IMultiGameComponent};
use crate::features::objectives::{ObjectivesComponent, IObjectivesComponent};
use crate::features::context::{ContextComponent, IContextComponent};
use crate::features::soulbound::{SoulboundComponent, ISoulboundComponent};
use crate::features::renderer::{RendererComponent, IRendererComponent};

use crate::core::interface::ICoreToken;
    ...
    impl ERC721HooksImpl of ERC721Component::ERC721HooksTrait<ContractState> {
        fn before_update(
            ...
            if config::SOULBOUND_ENABLED {
                ...
                if !SoulboundOptionalImpl::check_transfer_allowed(contract, token_id.try_into().unwrap()) {
