...
use crate::components::core::traits::{
    NoOpMultiGame, NoOpObjectives, NoOpContext, NoOpSoulbound, NoOpRenderer
};
...
mod MinimalOptimizedContract {
    ...
    impl MultiGameOptionalImpl = NoOpMultiGame<ContractState>;    // Zero-cost NoOp
