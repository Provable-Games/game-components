...
fn test_set_entry_fee_extension_stores_address_and_config() {
    ...
    let entry_fee = EntryFee::Extension(
        metagame_extensions_interfaces::extension::ExtensionConfig { address: ext_addr, config: config_data.span() },
    );
    mock.set_entry_fee(1, entry_fee);
...
fn test_set_entry_fee_extension_blocks_second_set() {
    ...
    let entry_fee = EntryFee::Extension(
        metagame_extensions_interfaces::extension::ExtensionConfig { address: ext_addr, config: array![0x1].span() },
    );
    mock.set_entry_fee(1, entry_fee);
    ...
    let entry_fee2 = EntryFee::Extension(
        metagame_extensions_interfaces::extension::ExtensionConfig { address: ext_addr2, config: array![0x2].span() },
    );
    mock.set_entry_fee(1, entry_fee2);
}
...
fn test_set_entry_fee_extension_with_empty_config() {
    ...
    let entry_fee = EntryFee::Extension(
        metagame_extensions_interfaces::extension::ExtensionConfig { address: ext_addr, config: array![].span() },
    );
    mock.set_entry_fee(1, entry_fee);
...
fn test_extension_address_isolation_by_context() {
    ...
    let entry_fee1 = EntryFee::Extension(
        metagame_extensions_interfaces::extension::ExtensionConfig { address: ext_addr1, config: array![].span() },
    );
    mock.set_entry_fee(1, entry_fee1);

    mock_extension_calls(ext_addr2);
    let entry_fee2 = EntryFee::Extension(
        metagame_extensions_interfaces::extension::ExtensionConfig { address: ext_addr2, config: array![].span() },
    );
    mock.set_entry_fee(2, entry_fee2);
