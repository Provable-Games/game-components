...
use game_components_minigame::interface::{IMinigameTokenData, IMinigame, IMinigameDispatcher, IMinigameDispatcherTrait};
...
pub mod MockGame {
    ...
    use game_components_minigame::interface::{IMinigameTokenData, IMinigame};
